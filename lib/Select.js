...
var Select = (0, _createReactClass2['default'])({
	...
	propTypes: {
		...
		closeButton: _propTypes2['default'].bool, // show a close button at the bottom of the list
		...
		multiRenderer: _propTypes2['default'].func, // mutli input display renderer function
	...
	getDefaultProps: function getDefaultProps() {
		return {
			...
			multi: false,
			multiRenderer: function(valueArray, instance) {
				var onClick = instance.props.onValueClick ? instance.handleValueClick : null;
				var renderLabel = instance.props.valueRenderer || instance.getOptionLabel;
				return valueArray.map(function (value, i) {
					return _react2['default'].createElement(
						instance.props.valueComponent,
						{
							id: instance._instancePrefix + '-value-' + i,
							instancePrefix: instance._instancePrefix,
							disabled: instance.props.disabled || value.clearableValue === false,
							key: 'value-' + i + '-' + value[instance.props.valueKey],
							onClick: onClick,
							onRemove: instance.removeValue,
							value: value
						},
						renderLabel(value, i),
  ...
  */
	...
	renderValue: function renderValue(valueArray, isOpen) {
		...
		if (this.props.multi) {
			return this.props.multiRenderer(valueArray, _this4);
	...
	selectChoice: function selectChoice(option, index) {
	...
	renderCloseButton: function renderCloseButton() {
		if(this.props.closeButton === true) {
			return _react2['default'].createElement(
				'button',
				{ type: 'submit', onClick:  this.closeMenu },
				'Close'
			);
		}
	},
